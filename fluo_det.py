...
def cal_NetYield2(eV0, Atoms, xHe=0, xAl=0, xKapton=0, WD=6.0, xsw=0, WriteFile='Y' , xsect_resonant=0.0, sample=''):
    ...
    print ('Include_SelfAbsorption=', Include_SelfAbsorption)
...
if __name__=='__main__':
    ...
    if testing:
        ...
        if option == 1:
            ...
            working_distance = 3.48
            sim_spectra(eV0, Atoms, xHe=1, xAl=0, xKapton=0, WD=working_distance, xsw=1, sample='')
        ...
        if option == 2: # Feb09 data analyzed Nov13
            eV0 = 8800.
            print2screen = 0
            Atoms = []
            atom=ElemFY('Al', 10e-6);     Atoms.append(atom)
